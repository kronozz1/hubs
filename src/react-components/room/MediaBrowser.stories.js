...
const avatarListing = {
  ...
  description: null,
  gltfs: {
    avatar: "https://localhost:8080/api/v1/avatars/yUXsaby/avatar.gltf?v=63734422084",
    base: "https://localhost:8080/api/v1/avatars/yUXsaby/base.gltf?v=63734422084"
  },
  id: "123",
  images: {
    preview: {
...
const avatar = {
  ...
  description: null,
  gltfs: {
    avatar: "https://localhost:8080/api/v1/avatars/XUbGngS/avatar.gltf?v=63773070094",
    base: "https://localhost:8080/api/v1/avatars/XUbGngS/base.gltf?v=63773070094"
  },
  id: "123",
  images: {
    preview: {
