      ...
      <div className={styles.banner_wrapper}>
        <div className={styles.banner_container}>
          ...
          <div className={styles.branding_container}>
            <h2>
              <FormattedMessage defaultMessage="Join the next evolution of TechnoMetaverse!" id="banner.title" />
            </h2>
            <p>
          ...
          <div className={styles.expand_wrapper}>
            <div className={styles.expand_container}>
              <div className={styles.expand_header}>
                <h2>
                  <FormattedMessage defaultMessage="Join the next evolution of TechnoMetaverse!" id="banner.expand-title" />
                </h2>
                <CloseButton
